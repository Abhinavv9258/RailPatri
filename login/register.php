...
<footer class=" text-center text-white" style="background-color: #171717;" id="con">
    ...
    <div class="container p-4" style="background-color: #171717;">
        ...
        <!-- Section: Form -->
        <!-- Section: Text -->
        <section class="mb-4"><p>This website is created by Abhinav Verma , Sai jeevan , Snehashish Samanta and Satyam Deepu in Industrial Summer training organized by Chandigarh University</p></section>
        <!-- Copyright -->
