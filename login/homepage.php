...
<body style="background-color: #DDDDDD;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto">
                ...
                <a class="nav-link" href="#status"><i class="fas fa-ticket-alt"></i> Train Tickets</a>
                <li class="nav-item"></li>
                        ...
                        <center>
                            ...
                            <table style="border:2px solid orange">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $row['Train_No'] ?></th>
                                    <th><?php echo $row['Train_Name'] ?></th>
                                    <th><?php echo $row['Owing_Rly'] ?></th>
    ...
    <div class="card" id="pnr">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-outline-primary"><i class="fas fa-ticket-alt"></i> Go ! </a>
        </div>
    </div>
...
<footer class=" text-center text-white" style="background-color: #171717;">
    ...
    <div class="container p-4" style="background-color: #171717;">
        ...
        <section class="mb-4">
            <p>
                This website is created by Abhinav Verma , Sai jeevan , Snehashish Samanta and Satyam Deepu in Industrial Summer training organized by Chandigarh University
            </p>
        </section>
