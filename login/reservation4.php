    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="Passenger_Name" class="form-control" id="inputUsername3" placeholder="Passenger Name">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="Gender" valye="Gender">
...
<footer class=" text-center text-white" style="background-color: #171717;" id="con">
    ...
    <div class="container p-4" style="background-color: #171717;">
        ...
        <section class="mb-4">
            <p>
                This website is created by Abhinav Verma , Sai jeevan , Snehashish Samanta and Satyam Deepu in Industrial Summer
                training organized by Chandigarh University
            </p>
        </section>
